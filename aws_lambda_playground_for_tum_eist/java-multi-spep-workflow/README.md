...
```bash
java-multi-spep-workflow$ sam build
```
...
```bash
java-multi-spep-workflow$ sam logs -n StockCheckerFunction --stack-name java-multi-spep-workflow --tail
```
...
```bash
java-multi-spep-workflow$ cd functions/<function-name>/
...
```bash
sam delete --stack-name java-multi-spep-workflow
```
